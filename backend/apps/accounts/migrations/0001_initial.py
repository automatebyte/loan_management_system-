    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('company_admin', 'Company Admin'), ('loan_officer', 'Loan Officer'), ('client', 'Client')], default='client', max_length=20)),
